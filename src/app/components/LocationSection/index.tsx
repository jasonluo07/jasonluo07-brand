  ...
  return (
    <section id="Location" className={appendClass}>
      ...
      <p className="text-center md:text-lg">
        You can find me at <a href="https://goo.gl/maps/3Z2Z1Y1Z2Z2Z2Z2Z2">Taipei 101</a> in Taipei, Taiwan.
      </p>
      <div className="mt-4 flex justify-center">
        <iframe
          ...
          height={600}
          allowFullScreen
          className={`h-[360px] w-[600px] border-0 lg:h-[540px] lg:w-[900px] ${!isLight && 'invert-90'}`}
        />
      </div>
    </section>
  );
